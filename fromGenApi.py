# -*- coding: utf-8 -*-
# @Time : 2020/8/19 18:53
# @Author : C4C
# @File : fromGenApi.py
# @Remark : 使用Gen API1  (该API限制大概为50次/小时。不太实用。)
...
def get_info(videoname,link_subject,header):
    ...
    url1 = 'https://api.rhilip.info/tool/movieinfo/gen?url='+link_subject
